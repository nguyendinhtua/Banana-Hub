...
--------------------------------------------------------------------
local Library = Update:Window("ZITTER HUB","11354741327")
--------------------------------------------------------------------
...
--------------------------------------------------------------------
Update:Notification("Hello, " ..game.Players.LocalPlayer.DisplayName.. " Welcome To ZITTER HUB Mobile! Enjoy Using it! ")
...
Main:Button("Mink Fake Transform",function()
    require(game:GetService("ReplicatedStorage").Notification).new("Mink V4! / By : ZITTER HUB"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Fishman V4! / By : ZITTER HUB"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Skypeian V4! / By : ZITTER HUB"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Ghoul V4! / By : ZITTER HUB"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Cyborg V4! / By : ZITTER HUB"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Human V4! / By : ZITTER HUB"):Display();
    wait()
    setthreadcontext(5)
...
spawn(function()
 ...
 pcall(function()
  ...
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SickScientist","Heal")
    ...
    local Current = P:Label("Current Bouns :")
        ...
        while wait() do
            pcall(function()
                ...
                if tonumber(Bounty) == 25000000 then
                    Current:Set("Current Bouns : "..Bounty1.." [ Max ]")
                elseif tonumber(Bounty) < 25000000 then
                    Current:Set("Current Bouns : "..Bounty1)
                end
            end)
        end
    end)
